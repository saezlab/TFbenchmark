...
# inferred = 3 tissues
networks = list.files('data/TF_target_sources/inferred/TCGA/pancancer/',  pattern = 'network_i3.sif', recursive = T, full.names = T)
networks2merge = append(networks2merge, values = networks)
...
write.csv(SCORES, file = 'data/TF_target_sources/omnipath_scores/TF_target_scores_PANCANCER.csv', row.names = F)
