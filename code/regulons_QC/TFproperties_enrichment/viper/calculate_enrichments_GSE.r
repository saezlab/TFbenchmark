...
p3b = ggplot(x, aes(y = NES, x = label, fill = p.value ) ) + geom_bar(stat = 'Identity')  + 
  coord_flip() +
...
p3b
ggsave('paper/figures/Figure3b.png', width = 12, height = 5, dpi = 300)
save(p3b, file = 'paper/figures/Figure3b.rdata')
