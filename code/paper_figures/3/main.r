...
ggsave(P, filename = 'paper/figures/Figure1b.png', width = 10, height = 10, dpi = 300)
P = cowplot::plot_grid(get_legend(p1), 
                       get_legend(p2), 
                       get_legend(p3), 
                       get_legend(p4),
                       rel_widths = c(1, 1, 1, 1), nrow = 2)
ggsave(P, filename = 'paper/figures/Figure1b_legends.png', width = 10, height = 10, dpi = 300)
